...
constexpr std::string_view rootB =
        "99212772759402419371725815443904067040803662092756";
...
TEST(Test_BigInt, Creation_Tests) {
    ...
    EXPECT_EQ(bigint(10000), 10000);
    EXPECT_EQ(bigint(100000000), 100000000);
    EXPECT_EQ(bigint(1000000000), 1000000000);
    EXPECT_EQ(bigint(10000000000), 10000000000);
...
TEST(Test_BigInt, Sqrt_Tests) {
    ...
    EXPECT_EQ(bigint::sqrt(2), 1);
    EXPECT_EQ(bigint::sqrt(100), 10);
    EXPECT_EQ(bigint::sqrt(99999999999), 316227);
    EXPECT_EQ(bigint::sqrt(std::string{kHugeB}), std::string{rootB});
    // EXPECT_EQ(bigint::sqrt(std::string{kHugeA}), std::string{kHugeA});
}
